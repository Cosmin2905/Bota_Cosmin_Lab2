...
namespace Bota_Cosmin_Lab2.Data
{
    public class Bota_Cosmin_Lab2Context : DbContext
    {
        ...
        public DbSet<Bota_Cosmin_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Bota_Cosmin_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Bota_Cosmin_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
